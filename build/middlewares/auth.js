...
var checkAuth = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var header, token, signature;
    return __generator(this, function (_a) {
        header = req.headers["authorization"];
        if (!header && !(header === null || header === void 0 ? void 0 : header.startsWith("Bearer"))) {
            return [2 /*return*/, res.end("empty token please enter token")];
        }
        // bearer token
        try {
            token = header.split(" ")[1];
            signature = jsonwebtoken_1.default.verify(token, password_utils_1.APP_SECRET);
