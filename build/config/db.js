    ...
    return __generator(this, function (_a) {
        ...
        try {
            mongoose
                ...
                .then(function () { return console.log(colors_1.default.green("Connected to MongoDB")); })
                .catch(function (err) { return console.error(colors_1.default.red("Connection error"), err); });
        }
        catch (error) {
